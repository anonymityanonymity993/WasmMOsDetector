...
int32_t start(void) {
    ...
    int32_t local0, local1, local2, local3, local4, local5, local6, local7, local8;
    ...
    /* local5 = (uint32_t)local3 >= (uint32_t)local4; */
    local5 = (uint32_t)local3 >= (uint32_t)local4;
    WRITE_VAR(var_start_after_ge_u, 3);

    /* local6 = i32.load(0) → memory[0]; */
    local6 = memory[0];

    /* local7 = local5 & local6; */
    local7 = local5 & local6;
    WRITE_VAR(var_start_after_and, 4);
    ...
    /* i32.store 0, local8 → memory[0] = local8; */
    memory[0] = local8;
    WRITE_VAR(var_start_store, 7);
